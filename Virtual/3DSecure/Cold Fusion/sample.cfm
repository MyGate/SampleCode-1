        ...
        <table width="800" border="0" cellpadding="0" cellspacing="0" bordercolor="#f8f9e8"  style="background-image: url())">
            <tr valign="top"> 
                <td height="500">
                    ...
                    <input type="hidden" name="txtApplicationID" value="C572C9CC-F2C8-4DC8-AC5E-48784B83AB35">
					...
					<input type="hidden" name="txtRedirectSuccessfulURL" value="http://localhost/SampleCode/Virtual/Cold Fusion/processResults.cfm">
                    <input type="hidden" name="txtRedirectFailedURL" value="http://localhost/SampleCode/Virtual/Cold Fusion/processResults.cfm">
