...
try
{
	...
	elseif (isset($_GET["tdslookup"]))
	{
		...
		if (isset($lookupResponse->tdsLookup->authRequired) && $lookupResponse->tdsLookup->authRequired == 'Y')
			acsPage($lookupResponse->tdsLookup->acsUrl, 'http://192.168.1.100/3DSecure/3DSecure.php?tdsAuthenticate=true', $lookupResponse->tdsLookup->payload, $lookupResponse->uidTransactionIndex);
				else
